...
//     image: "https://fest-automation.vercel.app/twitter-image.jpg", // Replace with your image
//   },
// };
...
//       <head>
//         <link rel="canonical" href="https://fest-automation.vercel.app/" /> {/* Replace with your domain */}
...
//               url: "https://fest-automation.vercel.app/",
...
//                 logo: {
//                   "@type": "ImageObject",
//                   url: "https://fest-automation.vercel.app/logo.png", // Replace with your logo
//                 },
//               },
//             }),
//           }}
...
export const metadata = {
  ...
  openGraph: {
    ...
    images: [
      {
        url: "https://fest-automation.vercel.app/header-01.png",
        width: 1200,
        height: 630,
        alt: "Alathurpadi Dars Fest Banner",
      },
  ...
  twitter: {
    ...
    title: "Alathurpadi Dars Fest | Fest Management",
    description: "Manage programs, participants, and hall tickets for Alathurpadi Dars Fest.",
    image: "https://fest-automation.vercel.app/twitter-image.jpg",
  },
};
...
export default async function RootLayout({ children }) {
  ...
  return (
    <html lang="en" dir="ltr">
      <head><link rel="canonical" href="https://fest-automation.vercel.app/" /><meta name="theme-color" content="#4f46e5" /><script type="application/ld+json" dangerouslySetInnerHTML={{__html: JSON.stringify({"@context":"https://schema.org","@type":"WebSite","name":"Alathurpadi Dars Fest","url":"https://fest-automation.vercel.app/","description":"Event management platform for Alathurpadi Dars Fest.","publisher":{"@type":"Organization","name":"Alathurpadi Dars Fest","logo":{"@type":"ImageObject","url":"https://fest-automation.vercel.app/logo.png"}}})}} /></head>
