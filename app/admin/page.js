            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  Welcome back, {session?.user?.name || "Admin"}! Manage your fest competitions
                </p>
              </div>
              <div className="flex items-center gap-4">
                <div className="text-right">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              {quickActions.map((action, index) => (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <div
                      className={`p-4 rounded-2xl bg-gradient-to-r ${action.color} shadow-lg mb-4 group-hover:shadow-lg ${action.hoverColor} transition-all duration-300`}
                    >
                      <action.icon className="w-8 h-8 text-white" />
                    </div>
                    <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-indigo-600 transition-colors">
...
//                     <span className="text-gray-700">Server Status</span>
//                     <span className="flex items-center gap-2 text-green-600 font-semibold">
//                       <div className="w-2 h h-2 rounded-full bg-green-500"></div>
//                       Online
//                     </span>
//                   </div>
//                   <div className="flex items-center justify-between">
