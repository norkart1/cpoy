            ...
            <div className="mb-8 flex flex-col sm:flex-row gap-4 sm:items-center">
              ...
              <div className="relative w-full sm:flex-1">
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/60 border border-gray-200 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-500 text-sm shadow-sm transition-all backdrop-blur-md"
              ...
              <div className="relative w-full sm:w-56">
                <select
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/60 border border-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-500 text-sm shadow-sm transition-all backdrop-blur-md appearance-none"
              ...
              <div className="relative w-full sm:w-56">
                <select
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-white/60 border border-gray-200 text-gray-800 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-indigo-500 text-sm shadow-sm transition-all backdrop-blur-md appearance-none"
                  aria-label="Filter competitions by stage"
                >
