...
export default function ContestantsPage() {
  ...
  <div class="bg-white p-8 rounded-xl shadow-lg text-center max-w-md w-full">
    <h1 class="text-2xl font-semibold text-red-600 mb-4">Registration Timed Out</h1>
    <p class="text-gray-600 mb-6">Your session has expired due to inactivity. Please try again.</p>
    <button onclick="location.href='/'" class="px-6 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition">
      Go to Home
    </button>
  </div>
</div>
